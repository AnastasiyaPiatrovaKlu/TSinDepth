...
export function getBookTitlesByCategory(category: Category = Category.JavaScript): Array<string> {
    ...
    return books.filter(({ category: cater }) => cater === category).map(({ title }) => title);
};
...
// function getBooksByCategory(JavaScript: Category, logCategorySearch: (err: Error, titles: string[]) => void) {
